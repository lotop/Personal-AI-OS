...
核心基础模板包 `01_templates/project-base-pack` 版本 `1.1.0` 已正式获得批准（PAOS-TMPL-002），支持正式创建（非 provisional）。核心结构模板包 `01_templates/core-template-pack` 版本 `1.1.2` 已正式获得批准（PAOS-TMPL-003）。
