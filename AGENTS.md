...
本文件是仓库根入口的 V1.1.3 Approved Router。V1.1.3 已由 Founder 批准；Canonical Authority 由 `PAOS-REL-004`、固定恢复证据与本地 annotated tag `v1.1.3` 共同证明。本文件只负责导航和最低限度安全边界，不承载全部治理正文。
